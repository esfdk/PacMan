...
public class DataTuple {
	...
	{
		return ((dist-0.0)/(this.numberOfNodesInLevel-0.0))*(1.0-0.0)+0.0;
	}
	...
	{
		return ((numOfPills-0.0)/(this.numberOfTotalPillsInLevel-0.0))*(1.0-0.0)+0.0;
	}
	
	public double normalizeNumberOfPowerPills(int numOfPowerPills)
	{
		return ((numOfPowerPills-0.0)/(this.numberOfTotalPowerPillsInLevel-0.0))*(1.0-0.0)+0.0;
	}
